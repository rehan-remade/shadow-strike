...
const SKILL = (function () {
  const BISHOP = sprite([
    ...
    '.oFFFFFFFFFso.',
    '..oppo..oppo..',
  ], { o: 0, W: C.robeW0, w: C.robeW1, G: C.gold, g: C.goldD, F: C.hair0, s: C.hair1, e: 0, x: 35, n: C.hamPink, m: C.hamPinkD, p: C.hamPink });
  const SH = 23;
  ...
  return {
    ...
    drawActor(k, p) {
      ...
      px(bkx + shown.bx, bky + shown.by + (shown.by < 0 ? -1 : 1), C.hamPink);
      const fg = fireGlow();
